...
public class CreateGiftWater : Skill {
    ...
    private IEnumerator SkillTrigger()
    {
        ...
        for (int i = 0; i < num; i++)
        {
            ...
            ins.GetComponent<GiftWater>().Boss = gameObject;
        ...
        //UtilManager.Instance.CreateEffcet("Skill/Boss/Greed/Whirlpool", this.transform.position + posList[i]); 
