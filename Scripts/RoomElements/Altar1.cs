...
public class Altar1 : RoomElement{
	...
	public void AddBuff()
	{
        ...
        Player.Instance.GetComponent<BuffManager>().CreateDifferenceBuff((change1 * 100 + attributeList[attribute1-1]) * 10000000 + 0301110,"Altar");
        Player.Instance.gameObject.AddComponent<GiveBuff>().Create((change2*100+attributeList[attribute2-1])*1000+001, 3, 1);
    }
